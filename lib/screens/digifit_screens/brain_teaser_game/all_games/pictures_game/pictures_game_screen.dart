...
//     }
//
//     // ✅ ISSUE 2 FIX: Check if buttons should be disabled
...
//     }
//
//     // ✅ ISSUE 2 FIX: Check phase - keep showing last pair even after result
...
//         return Column(
//           children: [
//             // ✅ ISSUE 4 FIX: Only show timer if not showing result
...
//                     // ✅ ISSUE 2 FIX: Buttons with disabled state
//                     Row(
//                       children: [
//                         Expanded(
//                           child: Opacity(
//                             opacity: shouldDisableButtons ? 0.5 : 1.0,
//                             child: GestureDetector(
//                               onTap: shouldDisableButtons
//                                   ? null
//                                   : () {
//                                       final controller = ref.read(
//                                         picturesGameControllerProvider(
//                                           widget.picturesGameParams?.levelId ??
//                                               1,
//                                         ).notifier,
//                                       );
...
//   }
//
//   // ✅ ISSUE 1 FIX: Updated _buildGameStack to keep placeholders visible
...
//           ),
//
//         // 🟡 Placeholders - ✅ ISSUE 1 FIX: Always show in Level 1 progress stage
...
//     debugPrint('here the cell is tap row and cols is ${row} and ${column}');
//     if (!mounted) {
//       debugPrint('here the cell is tap 2');
//       return;
//     }
//     ref
...
//
//   // ✅ ISSUE 3 FIX: Updated dialog to not auto-open
