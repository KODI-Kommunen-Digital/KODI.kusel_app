...
//   final List<bool>? markedCorrect; // Track correctly marked numbers
//   final List<bool>? markedWrong; // Track wrongly marked numbers
//
//   final int currentExpectedNumber; // Next number to mark (for level 1)
//   final int? selectedIndex; // Currently selected grid index
//   final bool? isAnswerCorrect;
//   final int totalGridSize; // rows * cols
//
...
class BrainTeaserGameDigitDashState {
  ...
  // Grid state
  final List<int?>? gridNumbers;
  final List<double>? gridAngles; // Store rotation angles for each cell
  ...
  final int maxTimerSeconds; // Store the initial timer value
